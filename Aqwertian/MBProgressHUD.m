...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
        self.color = nil;
		self.labelFont = [UIFont fontWithName:@"Futura-Medium" size:18];
		self.detailsLabelFont = [UIFont fontWithName:@"Futura-Medium" size:14];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
...
- (void)setLabelTextColor:(UIColor *)aLabelTextColor {
    labelTextColor = aLabelTextColor;
...
- (void)setupLabels {
    ...
    if (self.labelTextColor) label.textColor = self.labelTextColor;
