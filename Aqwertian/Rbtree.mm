// Rbtree.cpp: implementation of the Rbtree class.
//
//////////////////////////////////////////////////////////////////////
#include <string.h>
#include <stdio.h>
...
#define mk_new_ext(new_node, kkkey, vvval) {\
  new_node = (Rb_node) malloc(sizeof(struct rb_node));\
  new_node->v.val = vvval;\
  new_node->k.key = kkkey;\
  setext(new_node);\
  setblack(new_node);\
  setnormal(new_node);\
}

void rb_delete_val(Rb_node list, void *val) {
    Rb_node ptr;
    
    rb_traverse(ptr, list) {
        if (ptr->v.val == val) {
            rb_delete_node(ptr);
            return;
        }
...
Rb_node rb_insert_b(Rb_node n, char *key, void *val)
...
Rb_node rb_insert_a(Rb_node nd, char *key, void *val)
{
...
Rb_node rb_insertg(Rb_node tree, char *key, void *val, int (*func)(char *, char *))
{
