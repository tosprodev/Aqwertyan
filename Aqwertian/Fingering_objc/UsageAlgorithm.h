...
@property (nonatomic, retain) IOSIntArray *_frequency;
@property (nonatomic, retain) id<JavaUtilList> _firstKeys;
...
@property (nonatomic, retain) IOSCharArray *fingers;
...
@property (nonatomic, retain) AqwertianFingeringUsageAlgorithm *this$0;
@property (nonatomic, assign) int val$count;
@property (nonatomic, retain) IOSObjectArray *val$notes;
