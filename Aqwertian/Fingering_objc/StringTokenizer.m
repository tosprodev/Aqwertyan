...
//  source: /Users/nziebart/GoogleDrive/Aqwertian/util/StringTokenizer.java
//
...
- (void)setDelimiters:(NSString *)newDelimiters {
  [delimiters_ autorelease];
  delimiters_ = [newDelimiters copy];
}
...
- (void)setDelimiterCodePoints:(IOSIntArray *)newDelimiterCodePoints {
  [delimiterCodePoints_ autorelease];
  delimiterCodePoints_ = [newDelimiterCodePoints retain];
}
...
- (id)initWithNSString:(NSString *)str
  ...
  if ((self = [super init])) {
    ...
    ([delimiters_ autorelease], delimiters_ = [delim retain]);
...
- (int)skipDelimitersWithInt:(int)startPos {
  if (delimiters_ == nil) @throw [[[JavaLangNullPointerException alloc] init] autorelease];
...
- (NSString *)nextToken {
  ...
  delimsChanged_ = NO;
  newPosition_ = -1;
  if (currentPosition_ >= maxPosition_) @throw [[[JavaUtilNoSuchElementException alloc] init] autorelease];
...
- (void)dealloc {
  ([delimiterCodePoints_ autorelease], delimiterCodePoints_ = nil);
  ([delimiters_ autorelease], delimiters_ = nil);
  ([str_ autorelease], str_ = nil);
  [super dealloc];
}
