...
- (void) setup {
    ...
    self.backgroundView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"il-list-row.png"]];
    self.selectedBackgroundView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"il-list-row-pressed.png"]];
