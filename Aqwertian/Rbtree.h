...
#if !defined(AFX_RBTREE_H__14B91502_FAEE_11D2_87DB_0000C0280101__INCLUDED_)
#define AFX_RBTREE_H__14B91502_FAEE_11D2_87DB_0000C0280101__INCLUDED_
...
extern Rb_node rb_insertg(Rb_node tree, char *key, void *val,
                          int (*func)(char *, char *));
...
extern Rb_node rb_find_gkey(Rb_node root, char *key, int (*func)(char *, char *));
...
extern Rb_node rb_find_gkey_n(Rb_node root, char *key, int (*func)(char *, char *), 
                                 int *found);
...
extern Rb_node rb_insert_b(Rb_node nd, char *key, void *val);
extern Rb_node rb_insert_a(Rb_node nd, char *key, void *val);


extern void rb_delete_node(Rb_node node);  /* Deletes and frees a node (but 
                                             not the key or val) */
extern void rb_delete_val(Rb_node node, void *val);
extern void rb_free_tree(Rb_node root);  /* Deletes and frees an entire tree */

extern void *rb_val(Rb_node node);  /* Returns node->v.val -- this is to shut lint up */
...
#define rb_rtraverse(ptr, lst) \
  for(ptr = rb_last(lst); ptr != rb_nil(lst); ptr = rb_prev(ptr))
 

#endif // !defined(AFX_RBTREE_H__14B91502_FAEE_11D2_87DB_0000C0280101__INCLUDED_)
