...
+ (void)initialize {
  if (self == [AqwertianFingeringMusicFile_Note class]) {
    AqwertianFingeringMusicFile_Note_NOTES_ = [IOSObjectArray arrayWithObjects:(id[]){ @"C ", @"C#", @"D ", @"D#", @"E ", @"F ", @"F#", @"G ", @"G#", @"A ", @"A#", @"B " } count:12 type:[IOSClass classWithClass:[NSString class]]];
  }
}
