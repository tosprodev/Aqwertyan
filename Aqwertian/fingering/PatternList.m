...
- (id<JavaUtilList>)extractPatternsWithJavaIoBufferedReader:(JavaIoBufferedReader *)inArg {
  ...
  while ((line = [((JavaIoBufferedReader *) NIL_CHK(inArg)) readLine]) != nil) {
    lineCount++;
    AqwertianFingeringUtilStringTokenizer *tok = [[AqwertianFingeringUtilStringTokenizer alloc] initWithNSString:line];
    int count = 0;
    ...
    count /= 2;
    tok = [[AqwertianFingeringUtilStringTokenizer alloc] initWithNSString:line];
    AqwertianFingeringPatternList_Pattern *p = [[AqwertianFingeringPatternList_Pattern alloc] init];
