...
+ (id<AqwertianFingeringMusNotesFile_MusElement>)createWithNSString:(NSString *)line {
  if ([NIL_CHK(line) hasPrefix:[((AqwertianFingeringMusNotesFile_MusElement_TypeEnum *) NIL_CHK([AqwertianFingeringMusNotesFile_MusElement_TypeEnum NOTE])) getPrefix]]) return [[AqwertianFingeringMusNotesFile_MusNote alloc] initWithNSString:line];
  if ([NIL_CHK(line) hasPrefix:[((AqwertianFingeringMusNotesFile_MusElement_TypeEnum *) NIL_CHK([AqwertianFingeringMusNotesFile_MusElement_TypeEnum PIECE])) getPrefix]]) return [[AqwertianFingeringMusNotesFile_MusPiece alloc] initWithNSString:line];
  return [[AqwertianFingeringMusNotesFile_BasicElement alloc] initWithNSString:line];
}

- (id)initWithNSString:(NSString *)line {
  if ((self = [super init])) {
    _words_ = [AqwertianFingeringMusNotesFile_BasicElement parseLineWithNSString:line];
    _type_ = [AqwertianFingeringMusNotesFile_MusElement_TypeEnum fromPrefixWithNSString:((NSString *) [((id<JavaUtilList>) NIL_CHK(_words_)) getWithInt:0])];
