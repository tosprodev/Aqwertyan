...
- (id)initWithAqwertianFingeringQwertyMapper_AlgorithmEnum:(AqwertianFingeringQwertyMapper_AlgorithmEnum *)algorithm
  withAqwertianFingeringQwertyMapper_LevelOfDifficultyEnum:(AqwertianFingeringQwertyMapper_LevelOfDifficultyEnum *)level {
  return [self initWithAqwertianFingeringQwertyMapper_AlgorithmEnum:algorithm withAqwertianFingeringQwertyMapper_LevelOfDifficultyEnum:level withJavaUtilRandom:[[JavaUtilRandom alloc] init]];
}
...
- (AqwertianFingeringQwertyMapper_KeyHistory *)createKeyHistory {
  return [[AqwertianFingeringQwertyMapper_KeyHistory alloc] init];
}
...
+ (void)initialize {
  if (self == [AqwertianFingeringQwertyMapper class]) {
    AqwertianFingeringQwertyMapper_FINGER_ = [IOSObjectArray arrayWithObjects:(id[]){ @"R00", @"", @"", @"", @"", @"", @"", @"", @"", @"", @"", @"", @"R21", @"", @"R31", @"R41", @"R44", @"L44", @"L34", @"L24", @"L14", @"L14", @"R14", @"R14", @"R24", @"R34", @"", @"R42", @"", @"", @"", @"", @"", @"L42", @"L11", @"L21", @"L22", @"L23", @"L12", @"L12", @"R12", @"R23", @"R12", @"R22", @"R32", @"R11", @"R11", @"R33", @"R43", @"L43", @"L13", @"L32", @"L13", @"R13", @"L11", @"L33", @"L31", @"R13", @"L41" } count:59 type:[IOSClass classWithClass:[NSString class]]];
  }
}
