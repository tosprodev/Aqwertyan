...
@property (nonatomic, retain) id<AqwertianFingeringMapAlgorithm> _algo;
@property (nonatomic, retain) id<JavaUtilMap> _noteHist;
@property (nonatomic, retain) JavaUtilRandom *rand;
...
@property (nonatomic, retain) JavaUtilLinkedList *_mapped;
@property (nonatomic, retain) JavaUtilLinkedList *_playing;
