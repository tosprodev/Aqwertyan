...
- (int)_ticksPerBeat {
  return _ticksPerBeat_;
}

- (void)set_ticksPerBeat:(int)new_ticksPerBeat {
  _ticksPerBeat_ = new_ticksPerBeat;
}
...
- (id)initWithJavaIoInputStream:(JavaIoInputStream *)inArg {
  if ((self = [super init])) {
    ...
    _ticksPerBeat_ = ((ComAqwertianFingeringMidiFile_MThdChunk *) NIL_CHK(header)).ticksPerBeat;
...
- (id<JavaUtilList>)extractNotesWithJavaUtilCollection:(id<JavaUtilCollection>)channels {
  double beatsPerMinute = 1.0 / 500000.0 * 60.0 * 100000.0;
  ...
  for (int i = 0; i < [((id<JavaUtilList>) NIL_CHK(_events_)) size]; i++) {
    ...
    ComAqwertianFingeringMidiFile_Event *e = ((ComAqwertianFingeringMidiFile_Event *) [((id<JavaUtilList>) NIL_CHK(_events_)) getWithInt:i]);
      if ([((ComAqwertianFingeringMidiFile_Event *) NIL_CHK(e)) isLyrics]) {
          NSString *s = [e getLyrics];
          ...
          if (s) {
          [((id<JavaUtilList>) NIL_CHK(notes)) addWithId:[[ComAqwertianFingeringMusicFile_Note alloc] initWithInt:[((ComAqwertianFingeringMidiFile_Event *) NIL_CHK(e)) getChannel] withInt:((ComAqwertianFingeringMidiFile_Event *) NIL_CHK(e)).time withInt:0 withInt:0 withInt:0 withInt:0 withNSString:s]];
          }
      }
     
// usec/beat / 1000000 = sec/beat / 60 = min/beat

      if ([((ComAqwertianFingeringMidiFile_Event *) NIL_CHK(e)) isTempoChange]) {
          beatsPerMinute = (1.0 / (double)[((ComAqwertianFingeringMidiFile_Event *) NIL_CHK(e)) getTempo]) * 60.0 * 1000000.0;
      }

      

      if (![self processChannelWithJavaUtilCollection:channels withComAqwertianFingeringMidiFile_Event:e]) {
          continue;
      }
    ...
    if ([((ComAqwertianFingeringMidiFile_Event *) NIL_CHK(e)) isNoteOn]) {
      ...
      double rate = beatsPerMinute * _ticksPerBeat_;
      ...
      for (int j = i + 1; j < [((id<JavaUtilList>) NIL_CHK(_events_)) size]; j++) {
        ...
        if (!((ComAqwertianFingeringMidiFile_Event *) NIL_CHK(f)).visited && channel == [((ComAqwertianFingeringMidiFile_Event *) NIL_CHK(f)) getChannel] && note == [((ComAqwertianFingeringMidiFile_Event *) NIL_CHK(f)) getNote]) {
          ((ComAqwertianFingeringMidiFile_Event *) NIL_CHK(f)).visited = YES;
          foundNoteOff = YES;
          [((id<JavaUtilList>) NIL_CHK(notes)) addWithId:[[ComAqwertianFingeringMusicFile_Note alloc] initWithInt:channel withInt:((ComAqwertianFingeringMidiFile_Event *) NIL_CHK(e)).time withInt:((ComAqwertianFingeringMidiFile_Event *) NIL_CHK(f)).time - ((ComAqwertianFingeringMidiFile_Event *) NIL_CHK(e)).time withInt:note withInt:[((ComAqwertianFingeringMidiFile_Event *) NIL_CHK(e)) getVelocity] withInt:rate withNSString:nil]];
          break;
        }
      }
      if (!foundNoteOff) [((id<JavaUtilList>) NIL_CHK(notes)) addWithId:[[ComAqwertianFingeringMusicFile_Note alloc] initWithInt:channel withInt:((ComAqwertianFingeringMidiFile_Event *) NIL_CHK(e)).time withInt:_ticksPerBeat_ withInt:note withInt:[((ComAqwertianFingeringMidiFile_Event *) NIL_CHK(e)) getVelocity] withInt:rate withNSString:nil]];
    }
  }
  for (int i = 0; i < [((id<JavaUtilList>) NIL_CHK(_events_)) size]; i++) {
    ComAqwertianFingeringMidiFile_Event *e = ((ComAqwertianFingeringMidiFile_Event *) [((id<JavaUtilList>) NIL_CHK(_events_)) getWithInt:i]);
...
- (NSString *)description {
  ...
  [((JavaLangStringBuffer *) NIL_CHK(buff)) appendWithNSString:[NSString stringWithFormat:@"%d tpb", _ticksPerBeat_]];
  {
    id<JavaLangIterable> array__ = (id<JavaLangIterable>) _events_;
    if (!array__) {
      @throw [[JavaLangNullPointerException alloc] init];
...
- (id)initWithNSString:(NSString *)id_
 ...
 withJavaLangByteArray:(IOSByteArray *)data {
  if ((self = [super initWithNSString:id_ withInt:length])) {
    format_ = [ComAqwertianFingeringMidiFile toIntWithChar:[((IOSByteArray *) NIL_CHK(data)) byteAtIndex:0] withChar:[((IOSByteArray *) NIL_CHK(data)) byteAtIndex:1]];
    numTracks_ = [ComAqwertianFingeringMidiFile toIntWithChar:[((IOSByteArray *) NIL_CHK(data)) byteAtIndex:2] withChar:[((IOSByteArray *) NIL_CHK(data)) byteAtIndex:3]];
    if (([((IOSByteArray *) NIL_CHK(data)) byteAtIndex:4] & (int) 0x8000) == 0) {
      ticksPerBeat_ = [ComAqwertianFingeringMidiFile toIntWithChar:[((IOSByteArray *) NIL_CHK(data)) byteAtIndex:4] withChar:[((IOSByteArray *) NIL_CHK(data)) byteAtIndex:5]];
    }
    else {
      ticksPerBeat_ = ([((IOSByteArray *) NIL_CHK(data)) byteAtIndex:4] & (int) 0x7F) * [((IOSByteArray *) NIL_CHK(data)) byteAtIndex:5] / 2;
    }
  }
  return self;
}
...
- (void)parseChunkWithInt:(int)len
  ...
  while (offset < len) {
    ...
    if (((ComAqwertianFingeringMidiFile_Event *) NIL_CHK(e)).status == (char) (int) 0xFF) offset = [self parseMetaEventWithComAqwertianFingeringMidiFile_Event:e withJavaLangByteArray:data withInt:offset];
      ...
      if ([e status] == (char)0xf0 || [e status] == (char)0xf7) {
          
          // System Exclusive Event, ignore
...
- (BOOL)isNoteOn {
  return ((char) (status_ & (int) 0xF0) == (char) (int) 0x90) && [self getVelocity] != 0;
}

- (BOOL)isNoteOff {
  return ((char) (status_ & (int) 0xF0) == (char) (int) 0x80) || ([self isNoteOn] && [self getVelocity] == 0);
}

- (BOOL)isLyrics {
    if (status_ == (char) 0xFF) {
        if ([((IOSByteArray *) NIL_CHK(data_)) byteAtIndex:0] == (char) (int) 0x05) {
            return YES;
        }
        if ([((IOSByteArray *) NIL_CHK(data_)) byteAtIndex:0] == (char) (int) 0x01) {
            return YES;
        }
    }
    return NO;
...
- (BOOL)isTempoChange {
  return (status_ == (char) (int) 0xFF) && ([((IOSByteArray *) NIL_CHK(data_)) byteAtIndex:0] == (char) (int) 0x51);
}
...
- (int)getTempo {
  int val = [((IOSByteArray *) NIL_CHK(data_)) byteAtIndex:3];
  int tempo = val;
  val = [((IOSByteArray *) NIL_CHK(data_)) byteAtIndex:2];
  tempo += val << 8;
  val = [((IOSByteArray *) NIL_CHK(data_)) byteAtIndex:1];
  tempo += val << 16;
  return tempo;
}

- (NSString *)getLyrics {
  return [NSString stringWithBytes:data_ offset:1 length:(int) [((IOSByteArray *) NIL_CHK(data_)) count] - 1];
}
...
- (void)toStringWithJavaLangStringBuffer:(JavaLangStringBuffer *)buff {
  ...
  if (status_ == -1) {
    switch ([((IOSByteArray *) NIL_CHK(data_)) byteAtIndex:0]) {
      ...
      break;
      case (char) (int) 0x51:
      [[((JavaLangStringBuffer *) NIL_CHK(buff)) appendWithNSString:@"TP:"] appendWithInt:[self getTempo]];
      break;
      default:
